...
/**
 * <code>{@link XMLDBMS}</code>
 *
 * represents a XML DBMS.
 *
 * @author Calvin Chen
 */
public class XMLDBMS extends SimpleList<XMLShortcut>{
	
	private static final Logger log = LoggerFactory.getLogger(XMLDBMS.class);
	 ...
	 * @param xmlModel
	 */
	public XMLDBMS(Node currentNode, XMLModel xmlModel) {
		...
		if(ListUtil.isNotEmpty(nodeList)){
			...
			log.debug(INITIALLIZED_NAME, "XMLDBMS");
		}
	}
