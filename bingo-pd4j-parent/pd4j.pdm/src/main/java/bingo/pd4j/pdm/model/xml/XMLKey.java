...
public class XMLKey implements WithId{
	 ...
	 * @param xmlKeys
	 */
	public XMLKey(Node currentNode, XMLKeys xmlKeys) {
		this.superKeys = xmlKeys;
		...
		Node node = getNode(C_KEY_COLUMNS, currentNode);
		if(node != null){
			setKeyColumns(new XMLColumns(node, this));	
		}
	...
	public XMLColumns getKeyColumns() {
		return keyColumns;
	}
	...
	public void setSuperKeys(XMLKeys superKeys) {
