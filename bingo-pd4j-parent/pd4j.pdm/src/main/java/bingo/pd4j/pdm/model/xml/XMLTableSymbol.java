...
/**
 * <code>{@link XMLTableSymbol}</code>
 *
 * TODO : document me
 *
 * @author Calvin Chen
 */
public class XMLTableSymbol implements WithId{
	
	private static final Logger log = LoggerFactory.getLogger(XMLTableSymbol.class);
	 ...
	 * @param xmlSymbols
	 */
	public XMLTableSymbol(Node currentNode, XMLSymbols xmlSymbols) {
		...
		if(node != null){
			setObject(new XMLTables(node, this));	
		}
		
		log.debug(INITIALLIZED_NAME, "XMLTableSymbol");
	}
	...
	public XMLTables getObject() {
		return object;
	}

	public void setObject(XMLTables object) {
		this.object = object;
	}
